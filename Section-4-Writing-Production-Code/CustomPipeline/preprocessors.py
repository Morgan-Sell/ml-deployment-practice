...
class Pipeline:
    ...
    # Code is the nearly the same as in the Jupyter Notebooks.
    # Sole difference is the addition of "self"/
    ...
    def evaluate_model(self):
        ...
        # Apply np.exp because log transformation was applied to y_train...
        # ... when model was fitted.
        pred = np.exp(pred)
